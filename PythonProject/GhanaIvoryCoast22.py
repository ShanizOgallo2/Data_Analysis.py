...
def main():
    ...
    axes[0, 0].scatter(Ghana_df['Year'], Ghana_df['Yield(hg/ha)'], color="orange", marker="o")
    ...
    axes[1, 0].bar(Ghana_df['Year'], Ghana_df['Area_harvested(ha)'], color="saddlebrown")
    ...
    axes[1, 1].bar(Ivory_coast_df['Year'], Ivory_coast_df['Area_harvested(ha)'], color="yellow")
    ...
    plt.suptitle("Ghana Vs IvoryCoast Yield Trends",
